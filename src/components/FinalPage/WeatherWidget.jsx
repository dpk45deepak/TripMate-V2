    ...
    useEffect(() => {
        const fetchWeather = async () => {
            try {
                ...
                // Example: const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${location},${country}&units=metric&appid=YOUR_API_KEY`);
                ...
                <div className="text-center">
                    <div className="text-5xl mb-2">
                        {weatherData?.weather?.[0]?.main === "Sunny"
                            ? "☀️"
                            : weatherData?.weather?.[0]?.main === "Rainy"
                                ? "🌧️"
